...
import first from '/src/icons/testimonials/user.jpg'
import second from '/src/icons/testimonials/user2.jpg'
import third from '/src/icons/testimonials/user3.jpg'
import fourh from '/src/icons/testimonials/user4.jpg'
import fifth from '/src/icons/testimonials/user5.jpg'
import six from '/src/icons/testimonials/user6.jpg'
import seven from '/src/icons/testimonials/user7.jpg'
import eight from '/src/icons/testimonials/user8.jpg'
import nine from '/src/icons/testimonials/user9.jpg'
import ten from '/src/icons/testimonials/user10.jpg'
import eleven from '/src/icons/testimonials/user11.jpg'


const testimonials = [
    {name: 'Fredericka Michelin',
    message: `The best online zoo I've met. My son delighted very much ljves to watch gouillas. Online zoo is one jf the ways to instill a love for animals.The best online zoo I've met. My son delighted very much ljves to watch gouillas. Online zoo is one jf the ways to instill a love for animals.<br>
...
// console.log(testimonials[6].photo);